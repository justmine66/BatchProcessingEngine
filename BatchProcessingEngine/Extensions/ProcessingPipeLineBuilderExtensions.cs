...
namespace BatchProcessingEngine.Extensions
{
    ...
    public static class ProcessingPipeLineBuilderExtensions
    {
        ...
        private static readonly MethodInfo GetServiceInfo = typeof(ProcessingPipeLineBuilderExtensions).GetMethod("GetService", BindingFlags.Static | BindingFlags.NonPublic);
            ...
            params object[] args)
        {
            ...
            return pipeLine.UseMiddleware(next =>
            {
